...
export const pageButtons: TableButton[] = [
  {
    ...
    buttonCode: "TenderRemind.add", //itemName:TenderRemind.edit
  ...
  },
  {
    ...
    buttonCode: "TenderRemind.export", //itemName:TenderRemind.edit
  ...
  },
  {
    ...
    buttonCode: "TenderRemind.edit", //itemName:TenderRemind.edit
  ...
  {
    buttonName: "投标", //displayName:编辑
    buttonCode: "TenderRemind.tender", //itemName:TenderRemind.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
  ...
  {
    buttonName: "不投标", //displayName:编辑
    buttonCode: "TenderRemind.untender", //itemName:TenderRemind.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
  ...
  },
  {
    ...
    buttonCode: "TenderRemind.delete", //itemName:TenderRemind.edit
    buttonIcon: "", //itemName:edit
  ...
  tableRowButtons.forEach((element, index) => {
    if (index < 3) {
      ...
      buttons.push({
        ...
        buttonCode: "", //itemName:TenderRemind.edit
