...
export const pageButtons: TableButton[] = [
  {
    ...
    buttonCode: "EmployeeResignation.apply", //itemName:EmployeeResignation.edit
  ...
  //   buttonCode: "EmployeeResignation.export", //itemName:EmployeeResignation.edit
...

  {
    ...
    buttonCode: "EmployeeResignation.query", //itemName:EmployeeResignation.edit
...

  {
    ...
    buttonCode: "EmployeeResignation.audit", //itemName:EmployeeResignation.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
  ...
  {
    buttonName: "导出", //displayName:编辑
    buttonCode: "EmployeeResignation.exportOne", //itemName:StorageGoods.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
...

  {
    ...
    buttonCode: "EmployeeResignation.edit", //itemName:EmployeeResignation.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
  ...
  },
  {
    ...
    buttonCode: "EmployeeResignation.delete", //itemName:EmployeeResignation.edit
    buttonIcon: "", //itemName:edit
  ...
  },
  {
    ...
    buttonCode: "EmployeeResignation.hidden", //itemName:TodoList.edit
    buttonIcon: "", //itemName:edit
    buttonType: "primary", //itemName:primary
  ...
  tableRowButtons.forEach((element, index) => {
    if (index < 3) {
      ...
      buttons.push({
        ...
        buttonCode: "", //itemName:EmployeeResignation.edit
