...
import EPUser from "@iconify-icons/ep/user";
import CPU from "@iconify-icons/ep/cpu";
import Function from "@iconify-icons/ep/element-plus";
...
addIcon("check", Check);
addIcon("epUser", EPUser);
addIcon("cpu", CPU);
addIcon("function", Function);
addIcon("stamp", Stamp);
addIcon("menu", Menu);
addIcon("grid", Grid);
...
addIcon("document-checked", DocumentChecked);
...
addIcon("warningFilled", WarningFilled);
addIcon("questionFilled", QuestionFilled);
addIcon("house", House);
addIcon("more-Filled", MoreFilled);
addIcon("promotion", Promotion);
addIcon("copy-document", CopyDocument);
...
addIcon("arrow-left-line", ArrowLeftLine);
addIcon("arrow-right-line", ArrowRightLine);
